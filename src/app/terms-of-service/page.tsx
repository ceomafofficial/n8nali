                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                                {sections.map((section) => (
                                    <a
                                        key={section.id}
                                        href={`#${section.id}`}
                                        className="flex items-center text-sm text-gray-400 hover:text-accent-400 transition-colors py-1"
                                    >
                        ...
                        <div className="prose prose-invert prose-lg max-w-none">
                            ...
                            <div id="services" className="glass-card p-8 mb-8 scroll-mt-24">
                                ...
                                <div className="text-gray-400 space-y-4">
                                    ...
                                    <ul className="list-disc pl-6 space-y-2">
                                        <li><strong className="text-white">Workflow Automation:</strong> Design, development, and implementation of n8n-based automation workflows</li>
                                        <li><strong className="text-white">AI Voice Agents:</strong> Development and deployment of AI-powered voice assistants and conversational agents</li>
                                        <li><strong className="text-white">CRM Automation:</strong> Integration and automation of customer relationship management systems</li>
                                        <li><strong className="text-white">Business Process Optimization:</strong> Analysis and improvement of business workflows and operations</li>
                                        <li><strong className="text-white">Custom Integrations:</strong> API development and third-party system integrations</li>
                                        <li><strong className="text-white">Consulting Services:</strong> Strategic automation planning and advisory services</li>
                                    </ul>
                            ...
                            <div id="payment" className="glass-card p-8 mb-8 scroll-mt-24">
                                <h2 className="text-2xl font-display font-bold text-white mb-4 flex items-center">
                                    <Clock className="w-6 h-6 mr-3 text-accent-400" />
                                    4. Payment Terms
                                </h2>
                                <div className="text-gray-400 space-y-4">
                                    <p><strong className="text-white">Pricing:</strong> All fees and pricing for services will be outlined in individual project proposals or service agreements. Prices are quoted in USD unless otherwise specified.</p>
                                    <p><strong className="text-white">Payment Schedule:</strong></p>
                                    <ul className="list-disc pl-6 space-y-2">
                                    ...
                                    <p><strong className="text-white">Payment Methods:</strong> We accept payment via bank transfer, credit card, and major payment platforms. Specific payment instructions will be provided in invoices.</p>
                                    <p><strong className="text-white">Late Payments:</strong> Invoices not paid within 14 days of the due date may incur a late fee of 1.5% per month. We reserve the right to suspend services for accounts with outstanding balances.</p>
                                    <p><strong className="text-white">Refunds:</strong> Deposits are non-refundable once work has commenced. Refund requests for other payments will be evaluated on a case-by-case basis.</p>
                                </div>
                            </div>
                            ...
                            <div id="intellectual-property" className="glass-card p-8 mb-8 scroll-mt-24">
                                ...
                                <div className="text-gray-400 space-y-4">
                                    <p><strong className="text-white">Client Materials:</strong> You retain all ownership rights to materials, data, and content you provide to us (&quot;Client Materials&quot;). You grant us a limited license to use Client Materials solely for the purpose of delivering our services.</p>
                                    <p><strong className="text-white">Deliverables:</strong> Upon full payment, you will own the custom workflows, integrations, and configurations created specifically for your project (&quot;Custom Deliverables&quot;).</p>
                                    <p><strong className="text-white">n8nera IP:</strong> We retain ownership of:</p>
                                    <ul className="list-disc pl-6 space-y-2">
                                    ...
                                    <p><strong className="text-white">Third-Party Components:</strong> Deliverables may include third-party software, APIs, or services subject to their own license terms. You agree to comply with all applicable third-party licenses.</p>
                                </div>
                            </div>
                            ...
                            <div id="confidentiality" className="glass-card p-8 mb-8 scroll-mt-24">
                                ...
                                <div className="text-gray-400 space-y-4">
                                    ...
                                    <p><strong className="text-white">Confidential Information includes:</strong></p>
                                    <ul className="list-disc pl-6 space-y-2">
                                    ...
                                    <p><strong className="text-white">Exceptions:</strong> Confidentiality obligations do not apply to information that is publicly available, independently developed, rightfully obtained from third parties, or required to be disclosed by law.</p>
                            ...
                            <div id="warranties" className="glass-card p-8 mb-8 scroll-mt-24">
                                <h2 className="text-2xl font-display font-bold text-white mb-4 flex items-center">
                                    <AlertTriangle className="w-6 h-6 mr-3 text-accent-400" />
                                    7. Warranties & Disclaimers
                                </h2>
                                <div className="text-gray-400 space-y-4">
                                    <p><strong className="text-white">Our Warranties:</strong> We warrant that:</p>
                                    <ul className="list-disc pl-6 space-y-2">
                                    ...
                                    <p><strong className="text-white">Warranty Period:</strong> We provide a 30-day warranty period from delivery during which we will remedy any defects in deliverables at no additional cost.</p>
                                    <p><strong className="text-white">Disclaimers:</strong></p>
                                    <ul className="list-disc pl-6 space-y-2">
                            ...
                            <div id="liability" className="glass-card p-8 mb-8 scroll-mt-24">
                                ...
                                <div className="text-gray-400 space-y-4">
                                    <p><strong className="text-white">Liability Cap:</strong> To the maximum extent permitted by law, n8nera&apos;s total liability for any claims arising from or related to our services shall not exceed the total fees paid by you to n8nera in the twelve (12) months preceding the claim.</p>
                                    <p><strong className="text-white">Exclusion of Damages:</strong> In no event shall n8nera be liable for:</p>
                                    <ul className="list-disc pl-6 space-y-2">
                            ...
                            <div id="termination" className="glass-card p-8 mb-8 scroll-mt-24">
                                ...
                                <div className="text-gray-400 space-y-4">
                                    <p><strong className="text-white">Termination by Either Party:</strong> Either party may terminate a service agreement with 30 days written notice.</p>
                                    <p><strong className="text-white">Termination for Cause:</strong> Either party may terminate immediately if the other party:</p>
                                    <ul className="list-disc pl-6 space-y-2">
                            ...
                            <div id="governing-law" className="glass-card p-8 mb-8 scroll-mt-24">
                                ...
                                <div className="text-gray-400 space-y-4">
                                    <p><strong className="text-white">Governing Law:</strong> These Terms shall be governed by and construed in accordance with the laws of the United Arab Emirates, including the federal laws and applicable local laws of the Emirate of Dubai, without regard to conflict of law principles.</p>
                                    <p><strong className="text-white">Dispute Resolution:</strong> Any disputes arising from these Terms or our services shall be resolved through:</p>
                                    <ol className="list-decimal pl-6 space-y-2">
                                        <li><strong className="text-white">Negotiation:</strong> The parties shall first attempt to resolve disputes through good-faith negotiation</li>
                                        <li><strong className="text-white">Mediation:</strong> If negotiation fails, disputes shall be submitted to mediation</li>
                                        <li><strong className="text-white">Arbitration:</strong> If mediation fails, disputes shall be resolved through binding arbitration</li>
                                    </ol>
                                    <p><strong className="text-white">Jurisdiction:</strong> For any matters not subject to arbitration, the courts of the Emirate of Dubai, UAE shall have exclusive jurisdiction.</p>
                                </div>
                            </div>
                            ...
                            <div className="glass-card p-8 border-accent-500/30">
                                ...
                                <div className="text-gray-400 space-y-4">
                                    ...
                                    <ul className="list-none space-y-2">
                                        <li><strong className="text-white">Email:</strong> n8nera@gmail.com</li>
                                        <li><strong className="text-white">Phone:</strong> +92-314-160-3089</li>
                                        <li><strong className="text-white">Address:</strong> Satellite Town, Rahim Yar Khan, Pakistan</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
