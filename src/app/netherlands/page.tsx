                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <AnimatedSection>
                        ...
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-white mb-6">
                            ...
                            <span className="text-gradient">voor Nederlandse Bedrijven</span>
                        </h1>
                ...
                <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <AnimatedSection>
                        ...
                        <div className="prose prose-invert max-w-none" data-speakable="true">
                            ...
                            <h3 className="text-xl font-semibold text-white mb-4">Dutch Market Advantages</h3>
                            ...
                            <h3 className="text-xl font-semibold text-white mb-4">Key Industries in the Netherlands</h3>
            ...
            <section className="relative py-16 overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <AnimatedSection className="text-center mb-8">
                        <h2 className="text-2xl font-display font-bold text-white mb-4">We Also Serve</h2>
                    </AnimatedSection>
                    <div className="flex flex-wrap justify-center gap-4">
                        {[
