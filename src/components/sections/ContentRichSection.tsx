...
export default function ContentRichSection() {
    return (
        <section className="relative py-20 overflow-hidden" aria-label="Why business automation matters in 2026">
            <div className="absolute inset-0 bg-dark-900/50" />

            <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <article className="glass-card p-8 md:p-12" data-speakable="true">
                        <div className="flex items-center gap-3 mb-6">
                            <Sparkles className="w-6 h-6 text-accent-400" aria-hidden="true" />
                        ...
                        <div className="prose prose-invert max-w-none space-y-6">
                            <p className="text-gray-300 leading-relaxed" data-speakable="true">
                            ...
                            <ul className="space-y-3 my-6">
                                <li className="flex items-start gap-3">
                                    ...
                                    <span className="text-gray-300">
                                        <strong className="text-white">Sales Automation:</strong> Automatically capture leads from multiple sources, qualify them based on custom criteria, assign to sales reps, and trigger personalized follow-up sequences—all without manual intervention.
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" />
                                    <span className="text-gray-300">
                                        <strong className="text-white">Customer Service:</strong> Deploy AI voice agents that handle common inquiries in Arabic, English, Hindi, and Urdu, escalating complex issues to human agents with full context already gathered.
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" />
                                    <span className="text-gray-300">
                                        <strong className="text-white">Data Synchronization:</strong> Keep your CRM, accounting software, inventory management, and e-commerce platforms perfectly synchronized in real-time, eliminating manual data entry errors.
                                    </span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="w-5 h-5 text-emerald-400 flex-shrink-0 mt-0.5" />
                                    <span className="text-gray-300">
                                        <strong className="text-white">WhatsApp Business Automation:</strong> Send order confirmations, shipping updates, appointment reminders, and support messages automatically through WhatsApp, one of the world&apos;s most popular business communication channels.
                                    </span>
                                </li>
                            </ul>
                            ...
                            <div className="mt-10 p-6 bg-accent-500/10 border border-accent-500/20 rounded-lg">
