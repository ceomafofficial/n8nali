                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {links.map((link, idx) => (
                        <Link
                            key={idx}
                            href={link.href}
                            className="group glass-card p-5 hover:border-accent-500/30 transition-all duration-300"
                        >
                            <h3 className="text-sm font-semibold text-white group-hover:text-accent-400 transition-colors flex items-center justify-between">
                                {link.title}
